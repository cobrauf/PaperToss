...
public class ContourDrawing : MonoBehaviour
{
	...
	[Range(0f, 2f)] public float m_ContourWidth = 0.01f;
	[Range(0f, 16f)] public float m_AnimSpeed = 6f;
	[Range(0f, 2f)] public float m_AnimAmplitude = 0.01f;
	[Header("Internal")]
